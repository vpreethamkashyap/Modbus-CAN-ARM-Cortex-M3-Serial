...
//! transmisión de 1,5 caractéres (1,5T).
static uint32_t Modbus_OSL_RTU_Timeout_15;
//! \brief Nº de cuentas para establecer un timer que desborde en el tiempo de  
//! transmisión de 3,5 caractéres (3,5T).
...
//! ![Diagrama de Estados Modbus Serial RTU](../../RTU.png "Diagrama de Estados Modbus Serial RTU")
//*****************************************************************************
//! @{
...
{ 
  ...
  {
    case (1200):
      Modbus_OSL_RTU_Timeout_15=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_15[0];
      break;
      
    case (2400):
      Modbus_OSL_RTU_Timeout_15=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_15[1];
      break;
      
    case (4800):
      Modbus_OSL_RTU_Timeout_15=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_15[2];
      break;
      
    case (9600):
      Modbus_OSL_RTU_Timeout_15=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_15[3];
      break;
      
    case (19200):
      Modbus_OSL_RTU_Timeout_15=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_15[4];
      break;
      
    default:
      Modbus_OSL_RTU_Timeout_15=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_15[5];
      break;     
  }
}
...
{ 
  ...
  {
    case (1200):
      Modbus_OSL_RTU_Timeout_35=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_35[0];
      break;
      
    case (2400):
      Modbus_OSL_RTU_Timeout_35=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_35[1];
      break;
      
    case (4800):
      Modbus_OSL_RTU_Timeout_35=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_35[2];
      break;
      
    case (9600):
      Modbus_OSL_RTU_Timeout_35=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_35[3];
      break;
      
    case (19200):
      Modbus_OSL_RTU_Timeout_35=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_35[4];
      break;
      
    default:
      Modbus_OSL_RTU_Timeout_35=SysCtlClockGet(SYSCTL_M3SSDIV_2)/Timeout_35[5];
      break;     
  }
}
...
//!
//! Segun el estado en que se encuentre el programa en el momento de recibir
